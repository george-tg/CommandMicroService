...
class SecurityConfig {
    ...
    public ClientRegistrationRepository clientRegistrationRepository() {
        ...
        clientRegistrations.put("write-journal",
                ClientRegistration.withRegistrationId("write-journal")
                        .clientId("write-journal") // Replace with your actual client ID
                        .clientSecret("7dtDryvSEahyFvY0MIeYE44JlR3qzHam") // Replace with your actual client secret (avoid hardcoding in production)
